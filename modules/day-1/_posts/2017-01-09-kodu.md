...
Create a new world.
Add some panes to make the world bigger.
Add some peaks and/or hills to the terrain.
Add some water.
Add some water features (lily pads, clams, etc.).
Add three apples onto the hills.
Add Kodu
Program Kodu to move with the arrow keys
Program Kodu to turn with the WASD keys
Program Kodu to eat the apples when they collide
Test it!


Where do we go from here?

Add a rocket to the scene.
Have the rocket shoot at the kodu if they are in sight.
Have a countdown timer to start the game.
Have a score for when you collect apples.
Add more obstacles, items to collect, etc.
